			...
			<div class="dropdown">
				...
				<div class="droppedList">
				   <form action="<%=request.getContextPath()%>/servlet" target="center">
					   <button value="myInfo" type="submit" name="action" class="droppedList">My Profile</button>
				    </form>
				    <form action="<%=request.getContextPath()%>/servlet" target="center">
				    ...
				    <form action="<%=request.getContextPath()%>/servlet" method="post" target="_parent">
				    	<button value="signout" type="submit" name="action" class="droppedList">Logout</button>
				    </form>
				</div>
			</div>
