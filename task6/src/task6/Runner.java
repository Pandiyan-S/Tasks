...
public class Runner
{
	...
	/*private void lionOutput(Lion[] bakira)
	{
		for(int i=0;i<bakira.length;i++)
		{
			System.out.println("The height of Lion " + i + " is " + bakira[i].getheight());
			System.out.println("The weight of Lion " + i + " is " + bakira[i].getweight());
		}
	}*/
