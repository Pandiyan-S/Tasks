...
//		String[] str;
		while (choice != 21 && def < 10)
		{
			...
			try
			{
				...
				{
				case 1:
					List<String> createArrStringList = list.createStrList();
					System.out.println("The length of Array List is " + list.arrLen(createArrStringList));
					break;
				case 2:
					String[] str = run.multiInput();
					List<String> lengthArrStringList = list.addition(str);
					list.printList(lengthArrStringList);
					System.out.println("The length of Array List is " + list.arrLen(lengthArrStringList));
					break;
				case 3:
					System.out.println("enter the number of integers ");
					int noOfInt = run.intInput();
					int[] intNo = new int[noOfInt];
				...
				case 5:
					...
					List<Object> arrMixedList = list.multiAddition(mixedStr,intMixedNo,objMixedLion);
					list.printList(arrMixedList);
					System.out.println("The length of Array List is " + list.arrLen(arrMixedList));
					break;
				case 6:
					String[] findArr = run.multiInput();
					List<String> findArrStringList = list.addition(findArr);
					System.out.println("Enter the string to find ");
					String findStr = sc.nextLine();
					int index = list.find(findArrStringList,findStr);
					if(index == -1)
					{
					...
					System.out.println("The length of Array List is " + list.arrLen(findArrStringList));
					break;
				case 7:
					String[] printStr = run.multiInput();
					List<String> printArrStringList = list.addition(printStr);
					list.printList(printArrStringList);
					return;
				case 8:
					String[] indexStr = run.multiInput();
					List<String> showArrStringList = list.addition(indexStr);
					System.out.println("Enter the index to be displayed ");
					int pos = run.intInput();
					System.out.println("The string at given index is " + list.show(showArrStringList,pos));
					System.out.println("The length of Array List is " + list.arrLen(showArrStringList));
					break;
				case 9:
					String[] edgeStr = run.multiInput();
					List<String> findEdgeArrStringList = list.addition(edgeStr);
					System.out.println("Enter the string duplicate ");
					String dupeStr = sc.nextLine();
					int first = list.find(findEdgeArrStringList,dupeStr);
					int last = list.findLast(findEdgeArrStringList,dupeStr);
					if(first == -1)
					{
						System.out.println("the string does not exist in the list");
					}
					...
					break;
				case 10:
					String[] insertArr = run.multiInput();
					List<String> insertArrStringList = list.addition(insertArr);
					...
					insertArrStringList = list.insert(insertArrStringList,insertStr,insertIndex);
					list.printList(insertArrStringList);
					break;
				case 11:
					String[] subListStr = run.multiInput();
					List<String> subArrStringList = list.addition(subListStr);
					System.out.println("Enter the starting index ");
					int startIndex = run.intInput();
					System.out.println("Enter the ending index ");
					int endIndex = run.intInput();
					subArrStringList = list.subList(subArrStringList,startIndex,endIndex);
					list.printList(subArrStringList);
					break;
				case 12:
					String[] combStr = run.multiInput();
					List<String> firstArrList = list.addition(combStr);
					combStr = run.multiInput();
					List<String> secondArrList = list.addition(combStr);
					List<String> thirdArrList = list.combine(firstArrList,secondArrList);
					list.printList(thirdArrList);
					System.out.println("The length of Array List is " + list.arrLen(thirdArrList));
					break;
				case 13:
					String[] invCombStr = run.multiInput();
					List<String> invFirstArrList = list.addition(invCombStr);
					invCombStr = run.multiInput();
					List<String> invSecondArrList = list.addition(invCombStr);
					List<String> invThirdArrList = list.combine(invSecondArrList,invFirstArrList);
					list.printList(invThirdArrList);
					System.out.println("The length of Array List is " + list.arrLen(invThirdArrList));
					break;
				case 14:
					...
					List<Float> arrPointList = list.decimalAddition(point);
				...
				case 15:
					...
					List<Float> arrDecimalList = list.decimalAddition(decimal);
					...
					break;
				case 17:
					String[] excStr = run.multiInput();
					List<String> excFirstArrList = list.addition(excStr);
					excStr = run.multiInput();
					List<String> excsecondArrList = list.addition(excStr);
					List<String> excthirdArrList = list.exclude(excFirstArrList,excsecondArrList);
					list.printList(excthirdArrList);
					System.out.println("The length of Array List is " + list.arrLen(excthirdArrList));
					break;
				case 18:
					String[] retainStr = run.multiInput();
					List<String> retainFirstArrList = list.addition(retainStr);
					retainStr = run.multiInput();
					List<String> retainsecondArrList = list.addition(retainStr);
					List<String> retainthirdArrList = list.retain(retainFirstArrList,retainsecondArrList);
					list.printList(retainthirdArrList);
					System.out.println("The length of Array List is " + list.arrLen(retainthirdArrList));
					break;
				case 19:
					...
					List<Long> bigList = list.longAddition(big);
					bigList = list.empty(bigList);
					list.printList(bigList);
					System.out.println("The length of Array List is " + list.arrLen(bigList));
					break;
				case 20:
					String[] contStr = run.multiInput();
					List<String> contArrStringList = list.addition(contStr);
					System.out.println("Enter the string to find ");
					String searchStr = sc.nextLine();
					boolean check = list.contain(contArrStringList,searchStr);
					if(check)
					{
					...
					list.printList(contArrStringList);
					System.out.println("The length of Array List is " + list.arrLen(contArrStringList));
					break;
				case 21:
