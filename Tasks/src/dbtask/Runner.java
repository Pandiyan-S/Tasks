...
//		logger.info("\t1. Create a file sample.txt programmatically and write the lines.");
	...
	public void uploadDetails(Logger logger,Scanner sc) throws UserException
	{
	...
	public void retrieve(Logger logger,Scanner sc) throws UserException
	{
		DataBaseMethods db = new DataBaseMethods();
	...
	public void nEmployee(Logger logger,Scanner sc) throws UserException
	{
		DataBaseMethods db = new DataBaseMethods();
	...
	public void nSortedEmployee(Logger logger,Scanner sc) throws UserException
	{
		DataBaseMethods db = new DataBaseMethods();
		logger.info("Enter the number of the employee to show");
		int no = intInput(sc);
	...
	public static void main(String[] args)
	{
		...
		try
		{
			while (choice != 13 && def < 10)
			{
				...
				{
				case 1:
					db.create("create table Employee(EMPLOYEE_ID integer not null Auto_increment ,NAME varchar(30) not null ,"
							+ "MOBILE bigint not null, EMAIL varchar(40),DEPARTMENT varchar(30) not null,"
				...
				case 3:
					...
					logger.info("Enter the name of the employee");
					String name = sc.nextLine();
					List<Map<String,Object>> empList = db.findDetails(name);
					Iterator<Map<String,Object>> it = empList.iterator();
					while(it.hasNext())
					{
				...
				case 5:
					...
					List<Map<String,Object>> numberedEmpList = db.show(n);
					Iterator<Map<String,Object>> numIt = numberedEmpList.iterator();
					while(numIt.hasNext())
					{
				...
				case 6:
					...
					List<Map<String,Object>> sortedEmpList = db.sortedShow(no,sortColumn,direction);
					Iterator<Map<String,Object>> sortIt = sortedEmpList.iterator();
				...
				case 7:
					...
					List<Map<String,Object>> deletedEmpList = db.show(newNo);
					Iterator<Map<String,Object>> deleteIt = deletedEmpList.iterator();
				...
				case 8:
					...
					break;
				case 9:
					db.create("create table Dependent (EMPLOYEE_ID int not null,dependent_name varchar(30) not null,AGE int not null,"
							+ "RELATIONSHIP varchar(30) not null,Foreign key (EMPLOYEE_ID) REFERENCES Employee(EMPLOYEE_ID))");
					break;
				case 10:
				...
				case 11:
					...
					List<Map<String,Object>> dependentList = db.getDependent(ids);
					Iterator<Map<String,Object>> dependentIt = dependentList.iterator();
				...
				case 12:
					...
					int relationNO = run.intInput(sc);
					List<Map<String,Object>> mergeList = db.mergedDependent(relationNO);
					Iterator<Map<String,Object>> mergeIt = mergeList.iterator();
